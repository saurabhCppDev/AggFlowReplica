...
#include <memory>
#include "D:/Delta/QT/Workspace/AggFlowReplica/customdelegate.h"
...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "CustomDelegate\0sizeHintChanged\0"
};
...
void CustomDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomDelegate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CustomDelegate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomDelegate::sizeHintChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomDelegate::sizeHintChanged()
{
